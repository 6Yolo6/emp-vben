...
public interface SysUserService {
     ...
     * @return 分页结果
     */
    Page<UserVO> pageQueryVO(UserPageQueryDTO queryDTO);
     ...
     * @return 是否成功
     */
    boolean createUser(com.ldjt.emp.dto.UserCreateDTO dto);
     ...
     * @return 是否成功
     */
    boolean updateUser(Long userId, com.ldjt.emp.dto.UserUpdateDTO dto);

    /**
     * 获取用户权限信息（包含角色、岗位、直接权限）
     *
     * @param userId 用户ID
     * @return 用户权限信息
     */
     ...
     * @return 是否成功
     */
    boolean assignUserPermissions(Long userId, List<Long> menuIds);
}
